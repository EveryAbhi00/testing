  ...
  const educationData = [
    {
      ...
      duration: '2021 - 2024',
      description:
        'Specialized in statistical analysis, machine learning algorithms, and data visualization techniques. Graduated with honors.',
      achievements: [
        "Dean's List: 2020-2022",
        'Data Science Award 2021',
    ...
    },
    {
      ...
      duration: '2024 - 2026',
      description:
        'Comprehensive coursework covering data manipulation, visualization, and statistical analysis using Python and R.',
    ...
    //   duration: '2023',
    //   description:
    //     'Professional certificate focusing on applied machine learning models, feature engineering, and model deployment.',
    //   achievements: ['Capstone project on predictive analytics', 'Deep Learning Specialization'],
    // },
  ];
          ...
          {educationData.map((item, index) => (
            ...
            >
              <div className="grid md:grid-cols-[1fr_3fr] gap-6">
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold mb-3 text-cyberpunk-teal">{item.degree}</h3>
